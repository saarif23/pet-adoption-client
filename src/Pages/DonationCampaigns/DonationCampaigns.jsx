    ...
    return (
        <Container>
            <div className="my-10 grid grid-cols-1 md:grid-cols-2, lg:grid-cols-3 gap-10">
                ...
                className=" border bg-center bg-cover rounded-lg bg-black bg-blend-overlay bg-opacity-30 pl-10 pt-20 pb-8" style={{ backgroundImage: 'url("https://i.ibb.co/0cnRfTJ/7741802-removebg-preview.png")' }}>

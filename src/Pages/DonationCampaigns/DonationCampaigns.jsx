    ...
    return (
        <Container>
            <div className="my-10 grid grid-cols-1 md:grid-cols-2, lg:grid-cols-3 gap-10">
                <div className=" border bg-center bg-cover bg-black bg-blend-overlay bg-opacity-30 pl-10 pt-20 pb-8" style={{ backgroundImage: 'url("https://i.ibb.co/61fQkSd/samoyed-dog.jpg")' }}>
                    <p className=" border-l-2 border-fuchsia-600  text-fuchsia-500 font-bold mt-10">New Campaigns</p>

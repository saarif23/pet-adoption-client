      ...
      <div>
        <form onSubmit={formik.handleSubmit}>
          <div className="flex  flex-col md:flex-row  mx-auto gap-3 items-center p-2   my-5">
            ...
            >
              <input
                className="w-full focus:outline-[#279c46] border-2  py-2 px-2  focus:shadow-lg focus:outline-2   rounded-md "
                id="petName"
                name="petName"
                type="text"
            ...
            >
              <ReactSelect
                options={options}
                className="w-full focus:outline-[#279c46]  focus:shadow-lg focus:outline-2 text-black "
                name="category"
              ...
              {formik.touched.category && formik.errors.category && (
                <span className="text-sm text-[#279c46] pl-5">
            ...
            >
              <button
                type="submit"
                className="bg-[#279c46] rounded cursor-pointer hover:bg-[#246636]   py-2 px-10 w-full text-white font-bold text-lg"
              >
                Search
              </button>
            </div>
        ...
        <div className="my-10 grid grid-cols-1 md:grid-cols-2, lg:grid-cols-3 gap-10">
          ...
          >
            <p className=" border-l-2 pl-5 text-xl border-[#279c46]  text-[#279c46] font-bold mt-10">
              Adoption
            </p>
          ...
          {allLoadedPet?.map((pet) => (
            <SignlePet key={pet._id} pet={pet}></SignlePet>
          ))}
        </div>

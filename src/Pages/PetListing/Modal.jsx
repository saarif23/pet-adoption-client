...
const Modal = (_id) => {
  ...
  return (
    <>
      <button onClick={() => document.getElementById("modal_1").showModal()}>
        Adopt Now
      </button>
      ...
      {open && (
        <dialog id="modal_1" className="modal">
          <form
            ...
            className="bg-white rounded-lg w-[70%] p-10 text-black text-center"
          >
            ...
            <div className="w-1/2 mx-auto mt-5">
              <button
                type="submit"
                className="bg-[#279c46] w-full rounded-md py-2 mt-2 text-white  transition"
              >
                Submit
              </button>
            </div>

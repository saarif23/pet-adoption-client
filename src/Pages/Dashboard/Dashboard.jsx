        ...
        <div className="pt-24">
          <div className="lg:hidden">
            <div onClick={() => setIsOpen(!isOpen)}>
              {isOpen ? (
                <div className="flex flex-row items-center gap-3 p-3 justify-center rounded-md  w-44 mx-auto mb-10 shadow-xl text-fuchsia-600 font-bold mt-5  ">
                  <AiTwotoneCloseSquare size={36} />
                </div>
              ) : (
                <div className="flex flex-row items-center gap-3 p-3 justify-center rounded-md border-2 w-44 mx-auto mb-10 shadow-xl border-fuchsia-500 text-fuchsia-600 font-bold mt-5  ">

...
const Category = () => {
  ...
  return (
    <div
      style={{
        backgroundImage: "radial-gradient(#edf6ff, #F9FAFB, #F9FAFB)",
      }}
      className="py-10"
    >
      <Container>
        <div data-aos="zoom-in-up" data-aos-delay="50" data-aos-duration="1000">
          <Title
            heading={"All Pet category"}
            subHeading={
              "Creating Safe and Comfortable Spaces for Pets to Thrive"
            }
          />
        </div>
        <Swiper
